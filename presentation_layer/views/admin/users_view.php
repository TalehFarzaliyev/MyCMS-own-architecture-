                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="<?= SITE_URL ?>admin/users/"><?=$title?></a>
                                <i class="fa fa-circle"></i>
                            </li>
                        </ul>
                    </div>
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="btn-group">
                                            <a id="sample_editable_1_new" class="btn sbold green" href="<?= SITE_URL ?>admin/adduser"> Add User
...
foreach ($users as $key => $userobj) {
    ?>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td>
                                                        <a href="mailto:<?= $userobj->user_email ?>"> <?= $userobj->user_email ?> </a>
                                                    </td>

                                                    <td>
                                                        <a id="sample_editable_1_new" class="btn sbold green margin-right-5" href="<?= SITE_URL ?>admin/updateuser/<?= $userobj->user_id ?>">
                                                            <i class="fa fa-edit"></i>
                                                        </a>
                                                        <a id="" class="btn sbold green" href="<?= SITE_URL ?>admin/deleteuser/<?= $userobj->user_id ?>" onclick="return confirm('Are you sure you want to delete this item?');" >
