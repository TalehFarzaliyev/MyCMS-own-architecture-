                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                ...
                                                <input type="email" class="form-control" placeholder="Email Address" name="email" value = "<?php if(isset($email)){ echo $email; } ?>" > </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="form-actions fluid">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <a href="<?=SITE_URL?>admin/users" type="button" class="btn default">Cancel</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
